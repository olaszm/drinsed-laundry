      ...
      terms: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "You may cancel or reschedule your Order with no additional charge: at any time up to four hours before the agreed collection time via the App or by contacting support@drinsed.com; or if, after we have collected your Item(s), we are affected by an Event Outside Our Control by contacting support@drinsed.com.",
        ...
        },
        {
          ...
          bullets: [
            ...
            `We may contact you if we consider any Items to be at an increased risk of damage, including, but not limited to, those: WRONG`,
          ],
        },
        {
          name: "Wash and Fold Orders WRONG",
          bullets: [
...
`,
        ...
        {
          name: "Our liability to you WRONG",
          bullets: [
